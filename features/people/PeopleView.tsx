...
export function PeopleView() {
  ...
  const editPerson=(person:Person)=>{setEditingId(person.id);setDraft({firstName:person.firstName,lastName:person.lastName,email:person.email??"",phone:person.phone,birthDate:person.birthDate,siteId:person.siteId,status:person.status});setErrors({});setNotice("");setSelectedPerson(null);setFormOpen(true)};
