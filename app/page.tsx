...
function Application(){
  ...
  const effective=new Set(portal.permissions);const isAdministrative=["people.read","families.read","attendance.register","groups.manage","worship.view_team","training.manage","followups.read","ministries.read","reports.read","content.manage","access_requests.review","roles.manage","events.create","events.manage_ministry"].some(permission=>effective.has(permission));
